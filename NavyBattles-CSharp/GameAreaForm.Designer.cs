...
namespace NavyBattles_CSharp
{
	partial class GameAreaForm
	{
		...
		{
			this.myBoard = new GridView();
			this.enemyBoard = new GridView();
			...
			// myBoard
			// 
			this.myBoard.BackColor = System.Drawing.Color.Aquamarine;
			...
			// enemyBoard
			// 
			this.enemyBoard.BackColor = System.Drawing.Color.Aquamarine;
